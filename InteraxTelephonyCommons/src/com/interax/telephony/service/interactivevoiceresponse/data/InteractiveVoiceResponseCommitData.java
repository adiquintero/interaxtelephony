...
public class InteractiveVoiceResponseCommitData extends ServiceCommitData implements Serializable, InteractiveVoiceResponseData {
	...
	public String toString() {
		return "InteractiveVoiceResponseCommitData{startTime="+this.startTime.getTime()+",answerTime="+answerTime.getTime()+",stopTime="+this.stopTime.getTime()+",callDuration="+this.callDuration+",billSeconds="+this.billSeconds+",dialStatus="+this.dialStatus+",cdrId="+this.cdrId+",serviceType="+this.serviceType+",accessType="+this.accessType+",hangupCause="+this.hangupCause+"}";
	}
