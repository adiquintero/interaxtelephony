...
public class PickDialingOutgoingAgiConfig extends InteraxTelephonyConfig {
	...
	public PickDialingOutgoingAgiConfig(ResourceBundle rb)  throws MissingResourceException, NumberFormatException {
