...
public class IpPbxAmiConfig extends InteraxTelephonyConfig {
	...
	public IpPbxAmiConfig(ResourceBundle rb) throws MissingResourceException, NumberFormatException {
