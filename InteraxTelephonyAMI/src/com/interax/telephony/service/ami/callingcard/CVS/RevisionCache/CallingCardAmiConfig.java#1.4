...
public class CallingCardAmiConfig extends InteraxTelephonyConfig {
	...
	public CallingCardAmiConfig(ResourceBundle rb) throws MissingResourceException, NumberFormatException {
