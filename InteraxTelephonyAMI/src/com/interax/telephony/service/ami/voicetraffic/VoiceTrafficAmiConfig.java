...
public class VoiceTrafficAmiConfig extends InteraxTelephonyConfig {
	...
	public VoiceTrafficAmiConfig(ResourceBundle rb) throws MissingResourceException, NumberFormatException {
