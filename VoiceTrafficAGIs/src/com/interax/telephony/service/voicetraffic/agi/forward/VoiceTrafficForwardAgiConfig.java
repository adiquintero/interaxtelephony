...
public class VoiceTrafficForwardAgiConfig extends InteraxTelephonyConfig {
	...
	public VoiceTrafficForwardAgiConfig(ResourceBundle rb)  throws MissingResourceException, NumberFormatException {
