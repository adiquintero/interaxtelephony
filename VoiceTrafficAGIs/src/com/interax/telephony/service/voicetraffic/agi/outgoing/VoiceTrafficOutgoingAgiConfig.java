...
public class VoiceTrafficOutgoingAgiConfig extends InteraxTelephonyConfig {
	...
	public VoiceTrafficOutgoingAgiConfig(ResourceBundle rb)  throws MissingResourceException, NumberFormatException {
